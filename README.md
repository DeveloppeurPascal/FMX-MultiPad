...
You can edit one or more files at the same time in [FMX Multipad](https://github.com/DeveloppeurPascal/FMX-MultiPad) but if you prefer a one file text editor, use [FMX Notepad](https://github.com/DeveloppeurPascal/FMX-Notepad).
...
To download this code repository, we recommend using "git", but you can also download a ZIP file directly from [its GitHub repository](https://github.com/DeveloppeurPascal/FMX-MultiPad).
...
If you want an answer from the project owner the best way to ask for a new feature or report a bug is to go to [the GitHub repository](https://github.com/DeveloppeurPascal/FMX-MultiPad) and [open a new issue](https://github.com/DeveloppeurPascal/FMX-MultiPad/issues).
